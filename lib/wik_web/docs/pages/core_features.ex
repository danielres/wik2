defmodule WikWeb.Docs.Pages.CoreFeatures do
  use WikWeb.Docs.Page

  def slug, do: "core-features"
  def title, do: "Core features"
  ...
  def render(assigns) do
    ...
    For shared knowledge, notes, resources, guides, decisions, and evolving group memory.
