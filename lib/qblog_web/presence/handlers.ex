defmodule QblogWeb.Presence.Handlers do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      @impl true
      def handle_info({QblogWeb.Presence, {:join, presence}}, socket) do
        socket =
          socket
          |> QblogWeb.Presence.Handlers.forget_stale_presence(presence.id)
      ...
      @impl true
      def handle_info({QblogWeb.Presence, {:leave, presence}}, socket) do
        socket =
          socket
          |> QblogWeb.Presence.Handlers.delay_presence_removal(presence)
          |> handle_presence_change()
      ...
      @impl true
      def handle_info({QblogWeb.Presence, {:update, %{id: id}}}, socket) do
        socket =
          socket
          |> QblogWeb.Presence.Handlers.forget_stale_presence(id)
          |> handle_presence_change()
      ...
      @impl true
      def handle_info({QblogWeb.Presence, {:remove_stale, presence_id}}, socket) do
        socket =
          socket
          |> QblogWeb.Presence.Handlers.forget_stale_presence(presence_id)
          |> handle_presence_change()
