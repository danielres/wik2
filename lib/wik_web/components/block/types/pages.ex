defmodule WikWeb.Components.Block.Types.Pages do
  use WikWeb, :html

  alias WikWeb.Components.Block.Types.Pages.FormState
  alias WikWeb.Components.Block.Types.Pages.RenderState
