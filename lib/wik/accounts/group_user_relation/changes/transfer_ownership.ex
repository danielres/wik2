defmodule Wik.Accounts.GroupUserRelation.Changes.TransferOwnership do
  ...
  defp fetch_membership(target_membership_id) do
    Ash.get(GroupUserRelation, target_membership_id, authorize?: false, domain: Wik.Accounts)
  end
