...
#     assigns =
#       assigns
#       |> assign(:playlist_label, youtube_playlist_label(assigns.type, assigns.entry))
#       |> assign(:preview, entry_preview(assigns.type, assigns.entry))
#       |> assign(
#         :preview_field?,
...
#
#     ~H"""
#     <div class="grid min-w-0 grid-rows-subgrid text-left row-span-2 gap-4">
...
#     assigns =
#       assigns
#       |> assign(:map_embed_url, entry_map_embed_url(assigns.type, assigns.entry))
#       |> assign(:media, entry_media(assigns.type, assigns.entry))
#       |> assign(:playlist, entry_playlist(assigns.type, assigns.entry))
#       |> assign(:title, entry_title(assigns.type, assigns.entry))
#
#     ~H"""
...
#                 href={youtube_video_url(item.video_id)}
...
#
#   def youtube_playlist_label(type, entry) when is_map(type) and is_map(entry) do
#     media_value = entry_media_value(type, entry)
#
#     case media_embed(media_value) do
#       %{kind: :playlist, provider: :youtube} ->
#         playlist_label(Map.get(entry, :external_media_metadata), media_value)
#
#       _preview ->
#         nil
#     end
#   end
#
#   def youtube_playlist_label(_type, _entry), do: nil
#
#   defp entry_map_embed_url(type, entry) do
#     type.fields
...
#   end
#
#   defp entry_preview(type, entry) do
...
#   end
#
#   defp entry_playlist(type, entry) do
#     media_value = entry_media_value(type, entry)
#
...
#   end
#
#   defp youtube_video_url(video_id) do
...
#   end
#
#   defp playlist_label(_metadata, _media_value), do: "Playlist"
#
...
#
#   defp entry_field_icon(%{key: "organization"}), do: "hero-home-micro"
#   defp entry_field_icon(%{key: "role"}), do: "hero-academic-cap-micro"
#   defp entry_field_icon(%{key: "duration"}), do: "hero-clock-micro"
#   defp entry_field_icon(%{key: "creator"}), do: "hero-user-circle-micro"
