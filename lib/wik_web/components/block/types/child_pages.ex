defmodule WikWeb.Components.Block.Types.ChildPages do
  use WikWeb, :html

  alias WikWeb.Components.Block.Types.ChildPages.FormState
  alias WikWeb.Components.Block.Types.ChildPages.RenderState
