...
#   - Ex: docker.io/hexpm/elixir:1.18.4-erlang-27.3.4.8-debian-trixie-20260421-slim
#
...
RUN pnpm --dir assets install --frozen-lockfile
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/qblog ./
